'''
    Copyright (C) 2017 industrycoin Core
...
urlpatterns = [
    ...
    re_path(r'^get/?', retail.views.get_industrycoin, name='get_industrycoin'),
    ...
    # industrycoinbot
    url(settings.GITHUB_EVENT_HOOK_URL, industrycoinbot.views.payload, name='payload'),
