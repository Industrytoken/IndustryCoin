# -*- coding: utf-8 -*-
"""Define the industrycoin project settings.
...
if ENV in ['prod', 'stage']:
    ...
    STATIC_HOST = env('STATIC_HOST', default='https://s.industrycoin.co/')
    STATIC_URL = STATIC_HOST + env('STATIC_URL', default=f'{STATICFILES_LOCATION}{"/" if STATICFILES_LOCATION else ""}')
    MEDIA_URL = env(
        'MEDIA_URL', default=f'https://c.industrycoin.co/{MEDIAFILES_LOCATION}{"/" if MEDIAFILES_LOCATION else ""}'
    )
else:
...
ENS_TLD = env('ENS_TLD', default='industrycoin.eth')
...
GITHUB_APP_NAME = env('GITHUB_APP_NAME', default='industrycoin-local')
...
# optional: only needed if you run the industrycoinbot app
# Setup instructions: https://github.com/industrycoinco/web/blob/master/app/industrycoinbot/README.md
industrycoinBOT_APP_ID = env('industrycoinBOT_APP_ID', default='')
industrycoin_BOT_CERT_PATH = env('industrycoin_BOT_CERT_PATH', default='')
SECRET_KEYSTRING = ''
if industrycoin_BOT_CERT_PATH:
    with open(str(root.path(industrycoin_BOT_CERT_PATH))) as f:
        SECRET_KEYSTRING = f.read()

industrycoin_SLACK_ICON_URL = 'https://s.industrycoin.co/static/v2/images/helmet.png'
...
IGNORE_COMMENTS_FROM = ['industrycoinbot', ]
...
AWS_S3_CUSTOM_DOMAIN = env('AWS_S3_CUSTOM_DOMAIN', default='s.industrycoin.co')
MEDIA_BUCKET = env.str('MEDIA_BUCKET', default=AWS_STORAGE_BUCKET_NAME)
MEDIA_CUSTOM_DOMAIN = env('MEDIA_CUSTOM_DOMAIN', default='c.industrycoin.co')
AWS_DEFAULT_ACL = env('AWS_DEFAULT_ACL', default='public-read')
if not AWS_S3_OBJECT_PARAMETERS:
    AWS_S3_OBJECT_PARAMETERS = {'CacheControl': f'max-age={AWS_S3_CACHE_MAX_AGE}', }

CORS_ORIGIN_ALLOW_ALL = False
CORS_ORIGIN_WHITELIST = ('sumo.com', 'load.sumo.com', 'googleads.g.doubleclick.net', 'industrycoin.co', )
