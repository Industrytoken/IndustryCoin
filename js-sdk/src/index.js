...
class Widget {
  constructor(options = {}) {
    ...
    this.el = this.options.el || document.querySelector(options.selector || '.industrycoin-widget');
    ...
    fetch(`https://idtoken.pro/api/v0.1/bounties/?raw_data=${this.options.repository}&org=${this.options.organization}&network=mainnet&coinbase=unknown&order_by=${this.orderBy()}&limit=${this.limit()}`)
  ...
  static logo() {
    ...
    anchor.href = 'https://idtoken.pro';
    const logo = document.createElement('img');

    anchor.appendChild(logo);
    // need a srcset or svg logo for responsiveness
    logo.src = 'https://s.idtoken.pro/static/v2/images/logo.png';
    logo.className = 'industrycoin-widget__logo';
    return anchor;
  }
  ...
  static top() {
    ...
    top.className = 'industrycoin-widget__top';
  ...
  static bountyRow(bounties) {
    ...
    row.className = 'industrycoin-widget__bounty-row';
  ...
  static bounty(b) {
    ...
    bounty.className = 'industrycoin-widget__bounty';
    const anchor = document.createElement('a');
    ...
    expires.className = 'industrycoin-widget__expires';
    ...
    labels.className = 'industrycoin-widget__labels';
    labels.innerHTML = `<div class="industrycoin-widget__label industrycoin-widget__label--eth">${b.value_true} ${b.token_name}</div><div class="industrycoin-widget__label industrycoin-widget__label--usd">${b.value_in_usdt} USD</div>`;
  ...
  bottom() {
    ...
    bottom.className = 'industrycoin-widget__bottom';
  ...
  left() {
    ...
    left.className = 'industrycoin-widget__left';
    const avatar = document.createElement('img');

    avatar.className = 'industrycoin-widget__avatar';
    ...
    div.innerHTML = 'Browse issues at: <a href="https://idtoken.pro/explorer" title="industrycoin Explorer">https://idtoken.pro/explorer</a>';
  ...
  right() {
    ...
    right.className = 'industrycoin-widget__right';
    const bar = document.createElement('div');

    bar.className = 'industrycoin-widget__bar';
...
// Auto
if (document.querySelector('.industrycoin-widget')) {
  const found = document.querySelectorAll('.industrycoin-widget');
