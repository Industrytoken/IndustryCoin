# -*- coding: utf-8 -*-
"""Define the industrycoin Slack Welcome Bot flask app.
...
INDEX_REDIRECT_URL = os.environ.get('INDEX_REDIRECT_URL', 'https://idtoken.pro/slack')

app = Flask(__name__)


def get_default_message():
    """Return the industrycoin Welcomebot message."""
    return """
Welcome to industrycoin! :industrycoin:

industrycoin's mission is to *Grow Open Source*.

A few quick facts:
- We are mission driven.  Check out our mission: https://idtoken.pro/mission
- We aren't an ICO.  There is no industrycoin token.
- We are a community of blockchain developers.

Here's how to get started in the community
- Say hey :wave: in #community-intros
- Join the community livestream every Friday at 5pm EST: https://idtoken.pro/livestream

We believe that a great way to build new skills is to learn by doing, and industrycoin's core product (Bounties) supports that.

Here's how to get started with bounties:
- Developer? Start by completing the contributor onboarding at https://idtoken.pro/onboard/contributor and check out the open bounties at https://idtoken.pro/explorer
- Repo Owner? Accelerate your dev progress by posting a bounty of your own at https://idtoken.pro/new
- Send a tip to any github username with https://idtoken.pro/tip

We have more details in our onboarding guide at https://idtoken.pro/docs/onboard . We also have a FAQ and tutorials available at https://idtoken.pro/help
...
Welcome_bot (and the industrycoin Team)
