...
LABEL co.industrycoin.description="industrycoin web application image" \
    co.industrycoin.documentation="https://github.com/industrycoinco/web/blob/master/docs/RUNNING_LOCALLY_DOCKER.md" \
    co.industrycoin.licenses="AGPL-3.0" \
    co.industrycoin.image.revision=$SHA1 \
    co.industrycoin.image.vendor="industrycoin" \
    co.industrycoin.image.source="https://github.com/industrycoinco/web" \
    co.industrycoin.image.title="industrycoin Web" \
    co.industrycoin.image.created=$BUILD_DATETIME
