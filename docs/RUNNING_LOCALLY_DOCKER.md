...
## Add a Custom ERC20 Token To your Local industrycoin

1. [Create a django admin](https://github.com/industrycoinco/web/blob/master/docs/RUNNING_LOCALLY_DOCKER.md#create-django-admin)
...
5. Go back to your industrycoin local tab, and enter the token.
6. Click Save
...
Yes [click here](https://github.com/industrycoinco/web/blob/master/docs/KUDOS.md).
