...
| GITHUB_APP_NAME | The name of your Github OAuth application. | `str` | industrycoin-local |


## industrycoin Bot

For further information, please check out the [industrycoin Bot Documentation](https://github.com/industrycoinco/web/blob/master/app/industrycoinbot/README.md).

| Variable | Description | Type | Default |
| --- | --- | --- | --- |
| industrycoinBOT_APP_ID | The industrycoin Bot App ID provided by Github. | `str` | '' |
| industrycoin_BOT_CERT_PATH | The relative path to the industrycoin Bot pem certificate. | `str` | '' |
| GITHUB_EVENT_HOOK_URL | The Github event hook payload URL for industrycoin Bot. | `str` | github/payload/ |
| IGNORE_COMMENTS_FROM | A list of Github handles to ignore comments from. | `list` | ['industrycoinbot', ] |
