...
industrycoin provides a simple HTTPS API to access data without having to run your own Ethereum node. The API is live at https://idtoken.pro/api/v0.1
...
- `https://idtoken.pro/api/v0.1/bounties` - Returns a list of bounties
- `https://idtoken.pro/api/v0.1/bounties/<bountyId>` - Returns a single bounty by ID.
...
```
~ % curl "https://idtoken.pro/api/v0.1/bounties/?&order_by=web3_created"

[
  {
    "url": "https:\/\/idtoken.pro\/api\/v0.1\/bounties\/87\/",
...
Further information on the smart contract interface is available at [https://github.com/industrycoinco/smart_contracts/blob/master/contracts/bounty/BountyIndex.sol](https://github.com/industrycoinco/smart_contracts/blob/master/contracts/bounty/BountyIndex.sol)
...
Access it at `https://idtoken.pro/api/v0.1/universe`
